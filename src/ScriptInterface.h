...
static PyObject * thePlugin_get_document(PyObject *self, PyObject *args)
{
	wstring file;
	...
	wprintf(L"Send string: %s.\n", file.c_str());

	return (PyObject *)Py_BuildValue("u", file.c_str());
}

static PyObject * thePlugin_set_document(PyObject *self, PyObject *args)
{
	//char* _b;
	wchar_t* s;

	if (!PyArg_ParseTuple(args, "u", &s)) return NULL;
...
static PyMethodDef thePlugin_module_Methods[] =
{
	{
		"get_document",
		thePlugin_get_document,
		METH_VARARGS,
		""
	},
	{
		"set_document",
		thePlugin_set_document,
		METH_VARARGS,
		""
	},
	{
...
PyMODINIT_FUNC PyInit_thePlugin_module(void)
{
	...
	printf("init thePlugin_module module\n");
	return m;
}
...
PyMODINIT_FUNC PyInit_theDocument_module(void)
{
	...
	m = PyModule_Create(&thePlugin_module);
	if (m == NULL) return NULL;
	printf("init theDocument_module module\n");
	return m;
}